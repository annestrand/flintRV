  ...
  for (int i = 0; i < TEST_OP_RANGE; ++i) {
    ...
    for (int j = 0; j < TEST_RANGE; ++j) {
      ...
      case ALU_OP_ADD4A:
        ...
        break;
      case ALU_OP_XOR:
        r = p_alu->i_a ^ p_alu->i_b;
        break;
      case ALU_OP_SRL:
        r = p_alu->i_a >> p_alu->i_b;
        break;
      case ALU_OP_SRA:
        r = static_cast<signed int>(p_alu->i_a) >> p_alu->i_b;
        break;
      case ALU_OP_OR:
        r = p_alu->i_a | p_alu->i_b;
        break;
      ...
      case ALU_OP_NEQ:
        ...
        break;
      case ALU_OP_SLT:
        r = static_cast<signed int>(p_alu->i_a) <
            static_cast<signed int>(p_alu->i_b);
        break;
      case ALU_OP_SLTU:
        r = p_alu->i_a < p_alu->i_b;
        break;
...
TEST(unit, regfile) {
  ...
  uint32_t test_data[TEST_DATA_SIZE] = {
      0xdeadbeef, 0x8badf00d, 0x00c0ffee, 0xdeadc0de, 0xbadf000d,
      0xdefac8ed, 0xcafebabe, 0xdeadd00d, 0xcafed00d, 0xdeadbabe};
